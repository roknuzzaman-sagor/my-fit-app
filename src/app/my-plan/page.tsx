        ...
        <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-xl border border-base-content/15 bg-base-200 px-4 py-3 text-sm font-bold outline-none transition focus:border-[#ccff00]"
            >
              ...
              >
                ...
                <div className="flex flex-row flex-wrap gap-2">
                  <Link
                    ...
                    className="rounded-full border border-base-content/15 px-4 py-2 text-xs font-bold hover:border-[#ccff00] hover:text-[#ccff00]"
                  >
                    View Details
                  </Link>
                  ...
                  {activeTab === "plan" && (
                    <button
                      ...
                      className="rounded-full bg-[#ccff00] px-4 py-2 text-xs font-bold text-black hover:bg-[#d5ff33]"
                    >
                      ✓ Mark as Done
                    </button>
                  )}
                  ...
                  <button
                    ...
                    className="rounded-full border border-red-500/30 px-4 py-2 text-xs font-bold text-red-400 hover:bg-red-500/10"
                  >
                    ✕
                  </button>
                </div>
